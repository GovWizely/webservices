field_lists = {
  australia: [:agency, :contract_value, :description, :parent_id, :procurement_method, :publish_date_amended, :status, :industry, :ita_industries, :project_number, :publish_date, :start_date, :end_date, :country, :url, :source],
  ...
  uk:        [:country, :reference_number, :publish_date, :min_contract_value, :max_contract_value,
              ...
              :industry, :ita_industries, :specific_location, :source],
