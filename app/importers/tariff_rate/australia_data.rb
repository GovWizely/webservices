...
module TariffRate
  class AustraliaData
    ...
    ENDPOINT = "#{Rails.root}/data/fta_australia_tariff_rates/fta_australia_tariff_rates.csv"
    ...
    COLUMN_HASH = {
      ...
      tls_per_6_digit: :tls_per_6_digit,
      trq_quota: :trq_quota,
      trq_note: :trq_note,
    ...
    def process_row(row)
      ...
      entry[:country] = "AU"
      entry[:trq_note] = Sanitize.clean(entry[:trq_note], whitespace_elements: {})
