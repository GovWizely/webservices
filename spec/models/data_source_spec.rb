...
describe DataSource do
  describe 'validations' do
    ...
    %w(market_researches ita_office_locations ita_zip_codes ita_taxonomy screening_lists sharepoint_trade_articles envirotech api_models).each do |existing_api|
