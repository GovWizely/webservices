...
describe DataSource do
  describe 'validations' do
    ...
    %w(market_researches parature_faq ita_office_locations ita_zip_codes ita_taxonomy eccn screening_lists tariff_rates trade_leads trade_events envirotech sharepoint_trade_articles trade_articles api_models).each do |existing_api|
