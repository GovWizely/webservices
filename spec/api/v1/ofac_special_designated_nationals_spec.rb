...
describe 'OFAC Special Designated Nationals API V1' do
  include_context 'SDN data'
  let(:v1_headers) { { 'Accept' => 'application/vnd.tradegov.webservices.v1' } }

  describe 'GET /special_designated_nationals_list/search' do
    let(:params) { {} }
    before { get '/special_designated_nationals_list/search', params, v1_headers }
