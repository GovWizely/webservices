...
describe 'Fbopen Leads API V2', type: :request do
  before(:all) do
  ...
  describe 'GET /fbopen_leads/search.json' do
    ...
    context 'when q is specified' do
      before { get search_path, { q: 'toilETs' }, v2_headers }
      subject { response }
    ...
    context 'when industry is specified' do
      before { get search_path, { industry: '337920' }, v2_headers }
      subject { response }
    ...
    context 'when specific_location is specified' do
      before { get search_path, { specific_location: 'BR' }, v2_headers }
      subject { response }
