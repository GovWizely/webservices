...
describe 'Business Service Providers API V2', type: :request do
  ...
  describe 'GET /business_service_providers/search.json' do
    context 'when search parameters are empty' do
      ...
      before { get '/business_service_providers/search', {}, @v2_headers }
      subject { response }
  ...
  describe 'GET /business_service_providers/search.json' do
    context 'when one document matches a query and filter' do
      ...
      before { get '/business_service_providers/search', params, @v2_headers }
      subject { response }
