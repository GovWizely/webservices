...
describe 'Australian Trade Leads API V2', type: :request do
  before(:all) do
  ...
  describe 'GET /australian_trade_leads/search.json' do
    context 'when search parameters are empty' do
      before { get '/australian_trade_leads/search', {}, v2_headers }
      subject { response }
  ...
  describe 'GET /australian_trade_leads/search.json' do
    context 'when q is populated' do
      before { get '/australian_trade_leads/search', { q: 'motor' }, v2_headers }
      subject { response }
