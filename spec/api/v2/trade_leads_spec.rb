...
describe 'Trade Leads API V2', type: :request do
  before(:all) do
  ...
  describe 'GET /trade_leads/search.json' do
    context 'when search parameters are empty' do
      before { get '/trade_leads/search', {}, v2_headers }
      subject { response }
    ...
    context 'when size is specified' do
      before { get '/trade_leads/search', { size: 100 }, v2_headers }
      subject { response }
    ...
    context 'when countries is populated' do
      before { get '/trade_leads/search', { countries: 'GB' }, v2_headers }
      subject { response }
    ...
    context 'when q matches a title' do
      before { get '/trade_leads/search', { q: 'physician service' }, v2_headers }
      subject { response }
    ...
    context 'when q matches a description' do
      before { get '/trade_leads/search', { q: 'ambulatory' }, v2_headers }
      subject { response }
