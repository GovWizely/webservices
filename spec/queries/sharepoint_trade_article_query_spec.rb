...
describe SharepointTradeArticleQuery do
  ...
  describe '#generate_search_body' do
    ...
    context 'when options include creation_date filter' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/creation_date_filter.json").read }
    ...
    context 'when options include release_date filter' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/release_date_filter.json").read }
    ...
    context 'when options include expiration_date filter' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/expiration_date_filter.json").read }
    ...
    context 'when options include export_phases' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_export_phases.json").read }
    ...
    context 'when options include topics or subtopics' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_topics_fields.json").read }
    ...
    context 'when options include geo_regions or geo_subregion' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_geo_regions_fields.json").read }
    ...
    context 'when options include trade_regions' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_trade_regions.json").read }
    ...
    context 'when options include trade_programs' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_trade_programs.json").read }
    ...
    context 'when options include trade_initiatives' do
      ...
      let(:search_body) { JSON.parse open("#{fixtures_dir}/filter_trade_initiatives.json").read }
