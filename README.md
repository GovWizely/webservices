...
We're using [ElasticSearch](http://www.elasticsearch.org/) (>= 5.1.2) for fulltext search. On a Mac, it's easy to install with [Homebrew](http://mxcl.github.com/homebrew/).
